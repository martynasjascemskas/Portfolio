...
function Landing() {
  ...
  return (
    <>
      ...
      <span>Full Stack Developer ready to work on interesting and challenging projects</span>
      <h3><img src={locationPin} className="pin" alt="" /> Dublin, Ireland</h3>
      
      <div>
        <a href="https://www.linkedin.com/in/martynas-jascemskas/" target="_blank">
